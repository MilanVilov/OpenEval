...
from ai_eval.comparers.base import BaseComparer, _COMPARER_REGISTRY
...
def _load_entry_points() -> None:
    ...
    try:
        eps = importlib.metadata.entry_points(group="ai_eval.comparers")
    except Exception:
        return
...
def _ensure_builtins_imported() -> None:
    ...
    import ai_eval.comparers.exact_match  # noqa: F401
    import ai_eval.comparers.pattern_match  # noqa: F401

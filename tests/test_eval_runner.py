...
from ai_eval.providers.base import LLMResponse
...
def mock_repos():
    ...
    with (
        patch("ai_eval.services.eval_runner.get_session_context") as mock_session_ctx,
        patch("ai_eval.services.eval_runner.RunRepository") as mock_run_repo_cls,
        patch("ai_eval.services.eval_runner.ConfigRepository") as mock_config_repo_cls,
        patch("ai_eval.services.eval_runner.DatasetRepository") as mock_dataset_repo_cls,
        patch("ai_eval.services.eval_runner.ResultRepository") as mock_result_repo_cls,
        patch("ai_eval.services.eval_runner.read_csv_rows") as mock_read_csv,
        patch("ai_eval.services.eval_runner.call_llm") as mock_call_llm,
    ):
